...
#ifndef RECTANGLE_ROUNDED_H
#define RECTANGLE_ROUNDED_H
 ...
 */
class Rectangle_rounded : public Shape, public nsTransition::ITransitionable
{
...
public:
     ...
     */
    Rectangle_rounded(const nsGraphics::Vec2D& firstPosition, const nsGraphics::Vec2D& secondPosition, const nsGraphics::RGBAcolor& fillColor,
              const nsGraphics::RGBAcolor& borderColor = nsGraphics::KTransparent);
     ...
     * @fn Rectangle(const nsGraphics::Vec2D& position, const unsigned& width, const unsigned& height, const nsGraphics::RGBAcolor& fillColor,
              const nsGraphics::RGBAcolor& borderColor = nsGraphics::KTransparent);
     */
    Rectangle_rounded(const nsGraphics::Vec2D& position, const unsigned& width, const unsigned& height, const nsGraphics::RGBAcolor& fillColor,
              const nsGraphics::RGBAcolor& borderColor = nsGraphics::KTransparent);
     ...
     */
    virtual ~Rectangle_rounded() override = default;
     ...
     */
    Rectangle_rounded operator+(const nsGraphics::Vec2D& position) const;
     ...
     */
    Rectangle_rounded operator*(const float& f) const;
